...
7. **Doc-staleness scan.** Read `README.md`, `CLAUDE.md`, `TEAM.md`, `docs/CURRENT_CONFIG.md` against the latest commits. Open a `documentation` issue for each drift (commands, params, invariants, changelog gaps).
