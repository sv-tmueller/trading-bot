...
**Date:** 2026-07-06
**Status:** superseded by 2026-07-27-deprecate-upro-regime-bot.md (bot deprecation) and 2026-07-27-hourly-candlestick-signal.md (signal replacement)
...
| Faber 10-month SMA on 3x | Clears the headline US after-tax Calmar bar (0.19 vs SPY's 0.18) but the DE after-tax Calmar (0.17) misses it; max drawdown -63.5% busts the ~-34% ceiling, and per-window stability (0.38) is far below SPY's 0.85. Strictly dominated by tsmom-12mo on every axis the decision turned on. |
