...
# test:db is destructive and local-only: it refuses any SUPABASE_URL host that is not
# loopback (localhost, 127.0.0.0/8, ::1, host.docker.internal), naming the host it refused.
```
